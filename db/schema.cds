...
entity Orders : managed {
    key aufnr      : String(12); //Order
        ...
        operations : Composition of many Operations
...
entity Components : managed {
    ...
    key rspos     : String(4); //Item Number of Reservation/Dependent Requirement
        ...
        operation : Association to one Operations
                        on operation.aplzl = $self.aplzl; //Association to operation
}
...
entity Operations : managed {
    ...
    key aplzl     : String(8); //General counter for order
        ...
        components : Composition of many Components
                        on components.aplzl = $self.aplzl; //Component
}
